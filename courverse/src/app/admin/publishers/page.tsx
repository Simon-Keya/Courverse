...
import { useAdminPublishers } from "@/hooks/use-admin";

export default function AdminPublishersPage() {
  const query = useAdminPublishers();
  ...
  return (
    <div className="container-page py-8">
      <h1 className="font-heading text-2xl font-bold text-text">Admin · Publishers</h1>
      ...
      {query.isError && (
        <div className="mt-8 rounded-card border border-border bg-card p-6">
          <p className="text-sm text-text-secondary">
            Could not load publishers. The endpoint may not be available yet.
          </p>
